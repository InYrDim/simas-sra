...
export function SchoolProfileHistory({ domain, logoAssetId, records, canUploadLogo, canCreateAccreditation, canCorrectAccreditation }: { domain: string; logoAssetId: string | null; records: readonly SchoolAccreditation[]; canUploadLogo: boolean; canCreateAccreditation: boolean; canCorrectAccreditation: boolean }) {
