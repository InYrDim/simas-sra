      ...
      <header className="bg-white border-b border-slate-200 px-6 py-4 flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex gap-2">
          {current?.status === "published" ? (
            <Button nativeButton={false} render={<Link href="/ppdb/daftar" target="_blank" />} variant="outline" className="gap-1.5 border-sky-600 text-sky-700 hover:bg-sky-50 hover:text-sky-800">
