...
export default async function AbsensiKelasPage({
    ...
    await enforceTenantFeatureAccess(domain, "absensiKelas", "read");
    ...
    const mode = config?.activeLayers.kelas;
        ...
        <div className="flex flex-col gap-4 p-4">
            ...
            <div className="rounded-lg border bg-card text-card-foreground shadow-sm p-6">
                <p className="text-muted-foreground">
                    {mode
                        ? `Lapisan Kelas aktif dengan mode ${ATTENDANCE_MODE_LABELS[mode]}. Pencatatan absensi Kelas sedang dalam pengembangan.`
