...
export function parseSubjectForm(
  ...
  if (!code || !name || version !== undefined && (!Number.isSafeInteger(version) || version < 1) || Boolean(id) !== (version !== undefined)) return null;
  return { ...(id ? { id, version } : {}), input: { code, name, educationLevels: [educationLevel], description } };
}
