...
export type ClaimedExecutionRow = { executionId: string; tenantId: string; domain?: string; revisionId: string; rowId: string; actorId: string; claimedBy?: string; claimToken?: string; rolloutEpoch?: string | null };
