...
import { createStaffMasterDataService, type SchoolPerson, type StaffAudit, type StaffLifecyclePeriod, type StaffMasterDataStore, type StaffProfile, type StaffRelationshipBlocker } from "@/lib/master-data/staff-master-data";
...
function fixture() {
  const people: SchoolPerson[] = [], staffs: StaffProfile[] = [], periods: StaffLifecyclePeriod[] = [], assignments: import("@/lib/master-data/staff-master-data").StaffPositionAssignment[] = [], blockers: StaffRelationshipBlocker[] = [], audits: StaffAudit[] = [];
